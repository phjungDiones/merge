...
namespace CJ_Controls.Communication.CybogRobot_HTR
{
	...
	#endregion
	public class CyborgRobot_HTR : Component
	{
		#region Log 보내기
...
//                 procMsgEvent(10, 0, message);
		...
		private ACK_MODE RcvCheck(ref string sRcvData)
		{
			...
			if (IsReceived("\r\n") == true)
			{
				...
				sRcvData = GetReceiveDataEx_EndCut();//실제받아오는곳
				...
				else if (sRcvData.Contains("ERR") == true)
				{
                    ...
                    //ERR:201[CR][LF]
                    Global.GlobalFunction.Instance.GetErrNumber_0(sRcvData, Global.GlobalDefine.Eidentify_error.CyborgRobot_HTR);
	...
	public class CyborgRobot_Data
	{
		public CyborgRobot_Data()
		{
		}

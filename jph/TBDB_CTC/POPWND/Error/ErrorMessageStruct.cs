...
namespace TBDB_CTC.POPWND.Error
{
    public class ErrorMessageStruct
    {
        ...
        public ErrorMessageStruct(Eidentify_error e, string ErrorNumber)
        {
            ...
            string Path_CyborgRobot_HTR = @"C:\ErrorList\CyborgRobot_HTR.txt"; //ok
            string Path_Nano300 = @"C:\ErrorList\Nano300.txt";//ok
            string Path_Aligner_PA300C = @"C:\ErrorList\Aligner_PA300C.txt";//ok
            string Path_CyMechsRobot = @"C:\ErrorList\CyMechsRobot.txt";//ok

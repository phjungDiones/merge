...
namespace CJ_Controls.Windows
{
    ...
    /// </summary>
    public class Win_LedLabel : Control, ISupportInitialize
    {
        #region Nested Types
        /// <summary>
            ...
            float bevelRate, float segmentWidth, float segmentInterval)
        {
            switch (character)
            {
                ...
                case '_':
                    ...
                    break;
				case ':':
					DrawSegment(g, rectBound, colCharacter, 9, bevelRate, segmentWidth, segmentInterval);
					DrawSegment(g, rectBound, colCharacter, 10, bevelRate, segmentWidth, segmentInterval);
					break;
                case '(':
                    DrawSegment(g, rectBound, colCharacter, 1, bevelRate, segmentWidth, segmentInterval);
                    DrawSegment(g, rectBound, colCharacter, 6, bevelRate, segmentWidth, segmentInterval);
        ...
        private void CreateCache(Rectangle rectBound, float bevelRate, float segmentWidth, float segmentInterval)
        {
			...
			// draw upper :
			pathDotCollection[0].X = (rectBound.Width / 2) - (segmentWidth / 2);
			pathDotCollection[0].Y = rectBound.Height - (rectBound.Height / 4) - (segmentWidth / 2);
			pathDotCollection[1].X = (rectBound.Width / 2) + (segmentWidth / 2); ;
			pathDotCollection[1].Y = rectBound.Height - (rectBound.Height / 4) - (segmentWidth / 2);
			pathDotCollection[2].X = (rectBound.Width / 2) + (segmentWidth / 2); ;
			pathDotCollection[2].Y = rectBound.Height - (rectBound.Height / 4) + (segmentWidth / 2);
			pathDotCollection[3].X = (rectBound.Width / 2) - (segmentWidth / 2); ;
			pathDotCollection[3].Y = rectBound.Height - (rectBound.Height / 4) + (segmentWidth / 2);
			m_CachedPaths[8].AddPolygon(pathDotCollection);
			m_CachedPaths[8].CloseFigure();
			if (UseItalicStyle) m_CachedPaths[8].Transform(mx);

			// draw bottom :
			pathDotCollection[0].X = (rectBound.Width / 2) - (segmentWidth / 2);
			pathDotCollection[0].Y = rectBound.Height - ((rectBound.Height / 4) * 3) - (segmentWidth / 2);
			pathDotCollection[1].X = (rectBound.Width / 2) + (segmentWidth / 2); ;
			pathDotCollection[1].Y = rectBound.Height - ((rectBound.Height / 4) * 3) - (segmentWidth / 2);
			pathDotCollection[2].X = (rectBound.Width / 2) + (segmentWidth / 2); ;
			pathDotCollection[2].Y = rectBound.Height - ((rectBound.Height / 4) * 3) + (segmentWidth / 2);
			pathDotCollection[3].X = (rectBound.Width / 2) - (segmentWidth / 2); ;
			pathDotCollection[3].Y = rectBound.Height - ((rectBound.Height / 4) * 3) + (segmentWidth / 2);
			m_CachedPaths[9].AddPolygon(pathDotCollection);
			m_CachedPaths[9].CloseFigure();
			if (UseItalicStyle) m_CachedPaths[9].Transform(mx);
            // ok change state
        ...
        /// </summary>
        private GraphicsPath[] m_CachedPaths = new GraphicsPath[10];
        /// <summary>
        ...
        System.ComponentModel.DefaultValue(typeof(Win_LedLabel.Alignment), "Left")]

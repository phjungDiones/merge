...
namespace EraeMotionApi
{
   public class EMCL
   {
      ...
      *	Serial Comm APIs
      ************************************************************************/
       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static bool ERAETech_EMCL_OpenComm(int nPortNum, Int32 dwBaudRate);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static void ERAETech_EMCL_CloseComm(int nPortNum);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static bool ERAETech_EMCL_IsPortOpen(int nPortNum);
      ...
      ************************************************************************/
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_GetReply4(int nPortNum, ref byte nModuleId, ref byte nCmd, ref Int32 nValue, ref byte nType);
       ...
       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static int ERAETech_EMCL_WaitAndGetReply(int nPortNum, ref Int32 nValue);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_WaitAndGetReply3(int nPortNum, ref byte nModuleId, ref byte nCmd, ref Int32 nValue);
      ...
      *	resoultion
      ************************************************************************/
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_SetMicroStep(int nPortNum, byte nModuleId, Int32 nValue);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_GetMicroStep(int nPortNum, byte nModuleId);
      ...
      ************************************************************************/
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_SetZeroPosition(int nPortNum, byte nModuleId);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_SetEncoderZeroPosition(int nPortNum, byte nModuleId);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_SetMaxPositionSpeed(int nPortNum, byte nModuleId, Int32 nAccel);

      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_SetMaxAcceleration(int nPortNum, byte nModuleId, Int32 nAccel);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_Rotate(int nPortNum, byte nModuleId, int nDir, Int32 nVelocity);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_RotateRight(int nPortNum, byte nModuleId, Int32 nVelocity);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static int ERAETech_EMCL_RotateLeft(int nPortNum, byte nModuleId, Int32 nVelocity);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static int ERAETech_EMCL_Stop(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_MoveToPosition(int nPortNum, byte nModuleId, byte nMoveMode, Int32 nPosition);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetMaxPositionSpeed(int nPortNum, byte nModuleId, Int32 nAccel, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetMaxAcceleration(int nPortNum, byte nModuleId, Int32 nAccel, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_Rotate(int nPortNum, byte nModuleId, int nDir, Int32 nVelocity, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_RotateRight(int nPortNum, byte nModuleId, Int32 nVelocity, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_RotateLeft(int nPortNum, byte nModuleId, Int32 nVelocity, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_Stop(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_MoveToPosition(int nPortNum, byte nModuleId, byte nMoveMode, Int32 nPosition, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_MoveAbsolute(int nPortNum, byte nModuleId, Int32 nPosition, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_MoveRelative(int nPortNum, byte nModuleId, Int32 nPosition, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_MoveCoordinate(int nPortNum, byte nModuleId, Int32 nCoordNum, ref Int32 nRetValue);

      /************************************************************************
      *	get position, status
      ************************************************************************/
       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_IsMoving(int nPortNum, byte nModuleId);

      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_IsPositionReached(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static int ERAETech_EMCL_GetActualPos(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_GetEncoderPos(int nPortNum, byte nModuleId);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_GetActualCurrent(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_GetHomeSwitchStatus(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_GetRightLimitStatus(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_GetLeftLimitStatus(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_GetActualSpeed(int nPortNum, byte nModuleId);
      ...
      ************************************************************************/
      ...
      // Synchronous functions
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetDigitalOutput(int nPortNum, byte nModuleId, byte nOutPort, Int32 nValue, ref Int32 nRetValue);
      ...
      ************************************************************************/
      ...
      // Synchronous functions
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCoordinate(int nPortNum, byte nModuleId, byte nCoordNum, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_CaptureCoordinate(int nPortNum, byte nModuleId, byte nCoordNum, ref Int32 nRetValue);

      /************************************************************************
      *	reference
      ************************************************************************/
       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
       extern public static int ERAETech_EMCL_SetSearchMode(int nPortNum, byte nModuleId, Int32 nMode);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_SetRefSearchSpeed(int nPortNum, byte nModuleId, Int32 nValue);

      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_SetRefSwitchSpeed(int nPortNum, byte nModuleId, Int32 nValue);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_StartRefSearch(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_StopRefSearch(int nPortNum, byte nModuleId);

       [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)]
      extern public static int ERAETech_EMCL_GetRefSearchStatus(int nPortNum, byte nModuleId);
      ...
      // Synchronous functions
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetSearchMode(int nPortNum, byte nModuleId, Int32 nMode, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetRefSearchSpeed(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetRefSwitchSpeed(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_StartRefSearch(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_StopRefSearch(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_DisableRightSwitchStop(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_DisableLeftSwitchStop(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      ************************************************************************/
      ...
      // Synchronous functions
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetEncoderDeviation(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      ************************************************************************/
      ...
      // Synchronous functions
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetMaxCurrent(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLGammaVMin(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLGammaVMax(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLMaxGamma(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLBeta(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLOffset(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCurrentMin(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCurrentMax(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCorrectionVelocityP(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCorrectionVelocityI(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCorrectionVelocityIClip(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCorrectionVelocityDvClock(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLCorrectionVelocityDvClip(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLPositioningWindow(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLStartup(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLUpScaleDelay(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetCLDownScaleDelay(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      ************************************************************************/
      ...
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_ResetAlarm(int nPortNum, byte nModuleId);
      ...
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_ResetError(int nPortNum, byte nModuleId, Int32 nErrorType);	// 1:alarm, 4: pos Err,  5: all
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_SetServoOn(int nPortNum, byte nModuleId, Int32 nOnOff);

      // Synchronous functions
      [DllImport("EraeMotionApi.dll")] extern public static int ERAETech_EMCL_Sync_SetFreeWheeling(int nPortNum, byte nModuleId, Int32 nValue, ref Int32 nRetValue);
      ...
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_Sync_ResetAlarm(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_Sync_GetAlarmCode(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_Sync_ResetPosError(int nPortNum, byte nModuleId, ref Int32 nRetValue);
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_Sync_ResetError(int nPortNum, byte nModuleId, Int32 nErrorType, ref Int32 nRetValue);	// 1:alarm, 4: pos Err,  5: all
      [DllImport("EraeMotionApi.dll", CallingConvention = CallingConvention.Cdecl)] extern public static int ERAETech_EMCL_Sync_SetServoOn(int nPortNum, byte nModuleId, Int32 nOnOff, ref Int32 nRetValue);

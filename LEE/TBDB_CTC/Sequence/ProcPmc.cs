...
namespace TBDB_CTC.Sequence
{
    public class ProcPmc
    {
        ...
        public fn SetRecipe(PMC_RECIPE pmc_Rcp)
        {
            ...
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.Pressure, Convert.ToInt16(PmcInfo.dPressure));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.PressingTime, Convert.ToInt16(PmcInfo.dPressTimeSec));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.UpperTemp, Convert.ToInt16(PmcInfo.dUpperTemp));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.LowerTemp, Convert.ToInt16(PmcInfo.dLowerTemp));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.APCPosition, Convert.ToInt16(PmcInfo.dAPCPos));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.CH1Backlight, Convert.ToInt16(PmcInfo.dBacklightCH1));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.CH2Backlight, Convert.ToInt16(PmcInfo.dBacklightCH2));
            GlobalSeq.autoRun.prcVTM.Pmc.SetRecipe(CTC_RECIPE.CH3Backlight, Convert.ToInt16(PmcInfo.dBacklightCH3));

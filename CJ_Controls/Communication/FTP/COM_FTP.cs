...
{
	public class COM_FTPclient : Component
	{
		public COM_FTPclient()
		{
		}

		public COM_FTPclient(string Hostname)
		{
			_hostname = Hostname;
		}

		public COM_FTPclient(string Hostname, string Username, string Password)
		{
			_hostname = Hostname;
			_username = Username;
			_password = Password;
...
#else
		public string FtpCreateDirectory(string dirpath)
		{
			string str = "";
			string URI = this.Hostname + AdjustDir(dirpath);
			System.Net.FtpWebRequest ftp = GetRequest(URI);

...
namespace CJ_Controls.Pcomm32Functions
{
	...
	public class PMAC
	{
		...
		*/
		...
		[DllImport("Pcomm32.dll")]
		public static extern Int32 PmacGetControlResponseA(UInt32 dwDevice, StringBuilder s, UInt32 maxchar, Byte outstr);
		[DllImport("Pcomm32.dll")]
		public static extern Int32 PmacGetControlResponseExA(UInt32 dwDevice, StringBuilder s, UInt32 maxchar, Byte outstr);
